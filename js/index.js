        ...
        card.addEventListener('click', () => {
            ...
            memoryGame.pairsClicked++
                ...
                if (memoryGame.pickedCards.length === 2) {
                    if (memoryGame.checkIfPair(memoryGame.pickedCards[0].dataset.cardName && memoryGame.pickedCards[0].dataset.cardName) == true) {
                    ...
                    memoryGame.checkIfPair(this.card1, this.card2)
                }

            if (memoryGame.isFinished()) {
                h1 = "<h1>YOU WON THE GAME</h1>"
            }
