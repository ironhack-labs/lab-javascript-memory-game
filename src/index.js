...
const scoreboard = () => {
  const totalPairsClicked = document.querySelector('#pairs-clicked');
  const totalPairsGuessed = document.querySelector('#pairs-guessed');

  totalPairsClicked.textContent = memoryGame.pairsClicked;
  totalPairsGuessed.textContent = memoryGame.pairsGuessed
}
