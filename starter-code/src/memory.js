...
var MemoryGame = function (cards) {
  ...
  // LISTENS TO CLICKS AND CALLS CARD TOGGLE
  ...
  // CHECKS WHETHER THE TWO SELECTED CARDS ARE THE SAME
  ...
  this.winner = function () {
    alert(`De touw tieffus.... je hebt gewonnen na het bekijken van maarliefst ${this.pairsClicked} paartjes... Nog een spel? Klik op "OK"`)
  };
};